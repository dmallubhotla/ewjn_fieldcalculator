...
For small $x$, as shown in \fref{fig:plotx1to5}, the differences between the dipole source and the uniform source are
apparent.
...
In the regime shown in \fref{fig:plotx5to8} the dipole source effectively acts as a uniform source;
...
In the large $x$ region in \fref{fig:plotx8to10}, I think precision errors are a more noticeable contributor to the
